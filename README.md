...
```javascript
import imag from 'https://cdn.jsdelivr.net/gh/stdlib-js/complex-float64-imag@v0.1.0-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/complex-float64-imag/actions/workflows/test.yml/badge.svg?branch=v0.1.0
[test-url]: https://github.com/stdlib-js/complex-float64-imag/actions/workflows/test.yml?query=branch:v0.1.0
